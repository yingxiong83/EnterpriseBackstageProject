		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							总共${pageInfo.pages} 页，共${pageInfo.total} 条数据。 每页 <select class="form-control" id="changePageSize" onchange="javascript:changeSize()">
								<c:forEach begin="6" end="20" step="2" var="pageSize">
