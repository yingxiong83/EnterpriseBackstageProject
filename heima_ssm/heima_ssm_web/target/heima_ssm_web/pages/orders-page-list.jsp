                ...
                <div class="box-footer">
					...
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							<select class="form-control" name="size" id="changePageSize" onchange="javascript:changeSize()">
								<c:forEach begin="1" end="${pageInfo.total>10?10:pageInfo.total}" var="pageSize">
